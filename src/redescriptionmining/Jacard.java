...
public class Jacard {
    ...
    int disj(Redescription R1, Rule r, int side, DataSetCreator dat, Mappings map){
        ...
        String rrs = R1.ruleStrings.get(1-side);
        ...
        Iterator<String> it = rAt.iterator();
        while(it.hasNext()){
            if(redAt.contains(it.next()))
                return 0;
        }
